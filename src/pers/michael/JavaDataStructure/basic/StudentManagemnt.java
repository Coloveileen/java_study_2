	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			case"C":
				...
				System.out.print("please enter your Gendar:");	
		        ...
		        break;
			case"V":
				System.out.printf("%5s \t %20s \t %5s \t %5s %5s\n","SID", "Name", "Age", "Gendar","Score");
				for(int i = 0; i < students.size(); i++ ) {
					System.out.printf("%5d \t %20s \t %5d \t %5s %5d\n", 
							students.get(i).getNum(),students.get(i).getName(),
							students.get(i).getAge(),students.get(i).getGendar(),students.get(i).getScore());	
				}
				break;
			case"D":
				System.out.print("please enter SID for delete:");
